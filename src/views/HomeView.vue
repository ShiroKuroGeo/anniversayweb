<template>
    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
      <div class="container">
        <div class="navbar-brand">
          <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-5" href="index.html">Febuary 23
              2024</a></span>
        </div>
      </div>
    </nav>
  </section>
  <section class="cid-rGsOyzHk89" id="header3-1j">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:se="http://svg-edit.googlecode.com"
      ...
      xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" width="100%" height="100%" preserveAspectRatio="none"
      viewBox="0 0 858 235" style="">
      ...
      <div class="row">
        ...
        <div class="col-md-6 content align-left col-lg-6">
          <h1 class="mbr-section-title align-left mbr-white mbr-bold pb-3 mbr-fonts-style display-1">Happy Anniversary,
            Pumall!</h1>
          <p class="mbr-text pb-3 mbr-white mbr-semibold align-left mbr-fonts-style display-7">May this special day be
            filled with love, joy, and cherished memories as you celebrate the beautiful journey of your love together.
            Here's to many more years of happiness and togetherness.</p>
          <router-link class="align-left mbr-section-btn btn btn-md btn-primary display-4" to="/selection">Secret
            Message</router-link>
        </div>
      </div>
    </div>
  </section>
  <section class="cid-rGtDrCLJS9 mb-5" id="features8-3s">
    <div class="container">
      <div class="row">
        <div class="col-md-12 content col-lg-6 m-auto">
          <h1 class="mbr-section-title align-left mbr-bold pb-5 mbr-fonts-style display-2"><a href="#"><strong
                style="color: purple">Today's</strong></a> Message</h1>
          <div class="row">
            <div class="col-md-6 card">
              <div class="text">
                <h3 class="align-left mbr-bold mbr-fonts-style display-7">
                  Pumall, today is our special day — our 3rd Anniversary
                </h3>
              </div>
            </div>
          </div>
  ...
  <section class="features1 cid-rGtDy5Bq7v mt-5" id="features3-3t">
    <div class="container">
      <h1 class="mbr-section-title mbr-bold pb-3 align-center mbr-fonts-style display-2">My Words For Almost Everyday</h1>
      <div class="row">
        <div class="card col-12 col-md-6 col-lg-3">
          ...
          <div class="card-box m-auto">
            <h4 class="card-title align-center pb-3 mbr-white mbr-bold mbr-fonts-style display-5">I</h4>
          </div>
        </div>
        ...
        <div class="card col-12 col-md-6 col-lg-3">
          ...
          <div class="card-box m-auto">
            <h4 class="card-title align-center pb-3 mbr-white mbr-bold mbr-fonts-style display-5">Love</h4>
          </div>
        </div>
        ...
        <div class="card col-12 col-md-6 col-lg-3">
          ...
          <div class="card-box m-auto">
            <h4 class="card-title align-center pb-3 mbr-white mbr-bold mbr-fonts-style display-5">You</h4>
          </div>
        </div>
      </div>
